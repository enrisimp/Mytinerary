const cities = [
  ...
  },
  {
    ...
    fundation: "753 BC",
    population: 286884,
    photo: "https://i.im.ge/2022/08/31/OE8b5M.romeColosseum.png",
    city: "Rome",
    description:
      "Rome, the Eternal City, is the capital and largest city of Italy. It's known for its rich history, stunning architecture, and vibrant culture. The Colosseum, Roman Forum, and Pantheon are just a few of the many ancient landmarks that attract tourists from all over the world.",
    smalldescription:
      "Rome is a treasure trove of historical sites, including the iconic Colosseum, which was once the largest amphitheater in the world.",
    featuredLocation: "Colosseum",
  },

  {
    ...
    fundation: "c. 1600 BC",
    population: 664046,
    photo: "https://i.im.ge/2022/08/31/OE8Jzq.athensParthenon.png",
    city: "Athens",
    description:
      "Athens is one of the oldest cities in the world and is often referred to as the cradle of Western civilization. It's famous for its historical sites, including the Acropolis and the Parthenon, which stand as a testament to its ancient glory.",
    smalldescription:
      "Athens, with its ancient ruins and historical significance, offers visitors a glimpse into the birthplace of democracy and Western philosophy.",
    featuredLocation: "Acropolis",
  },

  {
    ...
    fundation: "c. 1046 BC",
    population: 21540000,
    photo: "https://i.im.ge/2022/08/31/OE8OjB.beijingGreatWall.png",
    city: "Beijing",
    description:
      "Beijing, the capital of China, is a city where modernity meets ancient history. From the magnificent Forbidden City to the iconic Great Wall, Beijing offers a blend of traditional culture and contemporary life.",
    smalldescription:
      "Beijing, home to both historic wonders like the Forbidden City and modern marvels like the Bird's Nest stadium, showcases China's past and future.",
